...
describe('StageComparatorTextTableComponent', () => {
  ...
  describe('sorting', () => {
    ...
    it('should sort stages by blastzone width descending when showing blastzone widths', () => {
      ...
      const inputSet: BinnedStageDimensionsSet = TEXT.DISPLAY_SORT_BLASTZONE.inputSet;
      const expectedClasses: string[] = TEXT.DISPLAY_SORT_BLASTZONE.expectedClasses;
      hostComp.binnedStageDimensionsSet = inputSet;
      hostFixture.detectChanges();
    ...
    it('should sort stages by floor length descending when showing floor lengths', () => {
      ...
      const inputSet: BinnedStageDimensionsSet = TEXT.DISPLAY_SORT_STAGELENGTH.inputSet;
      const expectedClasses: string[] = TEXT.DISPLAY_SORT_STAGELENGTH.expectedClasses;
      hostComp.binnedStageDimensionsSet = inputSet;
      hostFixture.detectChanges();
    ...
    it('should sort stages by off-stage distance descending when showing off-stage distances', () => {
      ...
      const inputSet: BinnedStageDimensionsSet = TEXT.DISPLAY_SORT_OFFSTAGE.inputSet;
      const expectedClasses: string[] = TEXT.DISPLAY_SORT_OFFSTAGE.expectedClasses;
      hostComp.binnedStageDimensionsSet = inputSet;
      hostFixture.detectChanges();
    ...
    it('should sort stages by ceiling height descending when showing ceiling heights', () => {
      ...
      const inputSet: BinnedStageDimensionsSet = TEXT.DISPLAY_SORT_CEILING.inputSet;
      const expectedClasses: string[] = TEXT.DISPLAY_SORT_CEILING.expectedClasses;
      hostComp.binnedStageDimensionsSet = inputSet;
      hostFixture.detectChanges();
