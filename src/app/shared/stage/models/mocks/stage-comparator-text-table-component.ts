...
export const DISPLAY_SORT_BLASTZONE: { inputSet: BinnedStageDimensionsSet, expectedClasses: string[] } = {
  ...
  expectedClasses: [
    "texttable_end_l_common",
    "texttable_duckhunt_",
    "texttable_skyward",
    "texttable_yoshi_cartboard_",
    "texttable_windyhill_",
    "texttable_xmadein_",
  ]
};
...
export const DISPLAY_SORT_OFFSTAGE: { inputSet: BinnedStageDimensionsSet, expectedClasses: string[] } = {
  ...
  expectedClasses: [
    "texttable_umbra_f",
    "texttable_poke_tengam_",
    "texttable_kirby_fountain_",
    "texttable_jack_mementoes_",
    "texttable_64jungle_",
    "texttable_mario_castledx_",
  ]
};
...
export const DISPLAY_SORT_CEILING: { inputSet: BinnedStageDimensionsSet, expectedClasses: string[] } = {
  ...
  expectedClasses: [
    "texttable_battlefield_l_",
    "texttable_yoshi_story_",
    "texttable_pictchat_",
    "texttable_dk_waterfall_",
    "texttable_kalos_",
    "texttable_xstarfox_",
  ]
};
